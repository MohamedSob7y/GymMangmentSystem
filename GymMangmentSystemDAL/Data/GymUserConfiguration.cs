...
namespace GymMangmentSystemDAL.Configuration
{
    ...
    public class GymUserConfiguration<T> : IEntityTypeConfiguration<T> where T : GymUser
    {
        public void Configure(EntityTypeBuilder<T> builder)
        {
          ...
          builder.HasIndex(T=>T.Email).IsUnique();
            ...
            builder.ToTable(T => T.HasCheckConstraint("PhoneConstrain","Phone like 'Phone like '01[0125]%'' "));//Phone Format '01' and Phone not like %[^0-9]%
